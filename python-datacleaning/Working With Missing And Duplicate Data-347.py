...
happiness2016.columns = happiness2016.columns = happiness2016.columns.str.replace(r'[\(\)]', '').str.strip().str.upper()
...
reg2017 = combined[combined["YEAR"] == 2017]
regions_2017 = reg2017['REGION']
