...
merged = pd.merge(left = happiness2015, right = world_dev, how = 'left', left_on = 'Country', right_on = world_dev['ShortName'])
...
value_counts = merged['lengths'].value_counts(dropna = False)
